...
import { Button, Input, Container, Loading, Card, Dropdown } from "@nextui-org/react";

export default function Home() {

  const [inputText, setInputText] = React.useState('');
  const [resultText, setResultText] = React.useState('');
  const [translateTo, setTranslateTo] = React.useState("turkish");
    ...
    <Container>
      ...
      <Container style={{marginTop: 50}}>
        ...
        <div style={{display: "flex", flexDirection: "column", gap: 15}}>
          <Input label="What to translate" onChange={(e) => setInputText(e.target.value) } type="text" placeholder='Some text to translate into turkish' clearable />
          <Input label="Translate to this language" onChange={(e) => setTranslateTo(e.target.value) } type="text" placeholder='Turkish' clearable />
          <Dropdown>
